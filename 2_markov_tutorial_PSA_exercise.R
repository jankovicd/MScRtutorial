...
plot(results_1$QALY_Trt - results_1$QALY_NoTrt, results_1$Cost_Trt - results_1$Cost_NoTrt,
     xlim = c(-1,1),
     ylim = c(-3000, 3000),
     xlab = "QALYs",
     ylab = "Costs (£)",
...
points(mean(results_1$QALY_Trt - results_1$QALY_NoTrt), mean(results_1$Cost_Trt - results_1$Cost_NoTrt),
       pch = 4, col = "red")
lines(c(-1,1), c(-20000, 20000), col = "red", lwd = 3)
abline(h=0)
abline(v=0)
